...
const getNotificacionesEnviadas=async(idUsuarioEnvia:string,idRolEnvia:string)=>{
...
export{getNotificaciones,insertNotificacion,editarVistaRecibeDocente,getNotificacionesEnviadas}