...
import { EliminarArchivoVontroller,insertarAPenalesController,insertarAPoliciacosController, insertarRenasController,obtenerRenasController,obtenerAntecedentesPenalesController,obtenerAntecedentesPoliciacosController } from '../controllers/RenasPolicialesPenales'
...
router.delete("/eliminararchivo/:id/:tipoArchivo",checkJwt,EliminarArchivoVontroller)
