...
import { fotoCursoProfeController,fotoPerfilProfeController,getFotoPerfilActivaProfesor,getProfesores,getProfesor,updateProfesor,deleteProfesor,insertarProfesor,compararPass,getGradoGuiaProfesor,getFotoCursoActivaProfesor} from "../controllers/profesores";
...
router.put("/profesor-foto-curso",checkJwt,fotoCursoProfeController)
