...
const notasalumnosFinalService = (idGrado) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const dataCursos = yield database_1.default.query("SELECT idCurso,abreviatura FROM tbCurso WHERE idGrado=? and consolidado_anual=1", [idGrado]);
        ...
        case 1:
            ...
            for (let i = 0; i < cantidadCursos; i++) {
                while (contador < dataAlumnos.length) {
                    ...
                    const consulta1 = yield database_1.default.query("SELECT CONCAT(a.apellidos_alumno,', ',a.nombres_alumno) as alumno,PromedioFinalCurso(" + idCursos[0] + ",a.idAlumno) as uno FROM tbAlumno a INNER JOIN tbCurso c WHERE a.idAlumno=? GROUP BY a.idAlumno ORDER BY a.apellidos_alumno", [idAlumnos[contador]]);
                    //array consultas
                    const notaArray1 = Object.values(consulta1);
                    //chingo de arrays
                    temp[contador] = {
