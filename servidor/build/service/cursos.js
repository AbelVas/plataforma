...
exports.obtenerProfePorCurso = exports.obtenerCursosPorAlumnoService = exports.obtenerCursosPorProfesorGradoSeccionService = exports.obtenerCursosPorGradoProfesorService = exports.obtenerCursosPorProfesorService = exports.obtenerCursosPorGradoService = exports.insertCursosService = exports.deleteCursosService = exports.updateCursosService = exports.obtenerCursoService = exports.obtenerCursosService = void 0;
...
const obtenerCursosPorProfesorService = (idProfesor) => __awaiter(void 0, void 0, void 0, function* () {
    const responseGet = yield database_1.default.query('SELECT c.idCurso, g.nombre_grado, n.nivel, n.idJornada, s.seccion, j.jornada, c.nombre_curso, c.idProfesor, c.abreviatura, c.creado, c.consolidado_bimestre, c.consolidado_anual, c.boletas, c.idGrado FROM tbCurso c INNER JOIN tbGrado g ON c.idGrado=g.idGrado INNER JOIN tbNivel n ON g.idNivel=n.idNivel INNER JOIN tbSeccion s ON g.idSeccion=s.idSeccion INNER JOIN tbJornada j ON n.idJornada=j.idJornada WHERE idProfesor=?', idProfesor);
    return responseGet;
});
