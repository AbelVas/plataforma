...
import { NotificacionesDocenteService } from 'src/app/profesor/services/notificaciones-docente.service';
...
@Component({
  selector: 'app-teacher-notificaciones-menu',
...
export class NotificacionesComponent implements OnInit {
  ...
  constructor(private notificacionesService:NotificacionesDocenteService,private socketService:WebSocketService) { }
