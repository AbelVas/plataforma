...
export class AlumnosCursoComponent implements OnInit {
  ...
  private modalAnuncio: any;
  private modalAnuncioEdit: any;
  ngAfterViewInit(): void {
    this.modalAnuncio = document.getElementById('modalCrearAnuncio');
    this.modalAnuncioEdit = document.getElementById('EditarAnuncio');
    if (this.modalAnuncio) {
      this.modalAnuncio.addEventListener('hidden.bs.modal', this.FormatSet.bind(this));
    }
    if (this.modalAnuncioEdit) {
      this.modalAnuncioEdit.addEventListener('hidden.bs.modal', this.FormatSet.bind(this));
    }
  }
