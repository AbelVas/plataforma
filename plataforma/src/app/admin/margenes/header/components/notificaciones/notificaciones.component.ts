...
import { NotificacionesAdminService } from 'src/app/admin/services/notificaciones-admin.service';
import { WebSocketService } from 'src/app/web-socket.service';
import { ToastrService } from 'ngx-toastr';
import decode from 'jwt-decode';

@Component({
  selector: 'app-admin-notificaciones-menu',
...
export class NotificacionesComponent implements OnInit {
  ...
  constructor(private notificacionesService:NotificacionesAdminService,private socketService:WebSocketService) { }
